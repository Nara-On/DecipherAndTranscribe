...
class preProcess:
    def __init__(self):
        ...
        n_classes, num_train, num_valid, num_test, self.datasets = IAM.getData(
            None, None, None
        )
    ...
    def processData(self, max_pool_num):
        ...
        validationLabel, validationLabel_mask = self.label_padding(
            validationLabel, self.num_tokens
        )
        total_data_train = []
        ...
        while True:
            for i in range(batches):
                ...
                yield {
                    "index_sa_t": index,
                    "input_sa_t": in_data,
                    "output_sa_t": out_data,
                    "out_len_sa_t": out_data_mask,
                    "in_len_sa_t": in_len,
                }
