...
if __name__ == '__main__':
    ...
    string = maxString("../../databases/copiale_real-vs-sint/sint/transcriptions/", 
                            os.listdir("../../databases/copiale_real-vs-sint/sint/transcriptions/")[0:1502])
    ...
    predsAStr = decodePred(preds_ex3, "")
    predsBStr = decodePred(preds_ex3, "@")
    predsCStr = decodePred(preds_ex3, "<ERROR>")
    predsDStr = decodePred(preds_ex3, "€//0/")
    gtStr = decode(gt)
    ...
    cerD = cer(" ".join(predsDStr), " ".join(gtStr)).item()
